...
# KEEPING DATASET: L3S Super-collated (Native in Celsius)
DATASET_ID = "noaacwLEOACSPOSSTL3SnrtCDaily"

def fetch_and_convert():
    print(f"Connecting to L3S: {DATASET_ID}")
...
def process_stack(data_contents):
    # netCDF4 automatically applies scale_factor and add_offset for this dataset
    ...
    features = []
    # Full pixel density - no range steps
    ...
    print(f"Success! Created Fahrenheit L3S map with {len(features)} points.")
